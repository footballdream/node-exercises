...
// Signin Controller
controllersModule.controller('SigninController', ['$scope', '$location', 'SigninService',
...
// sentence控制器
controllersModule.controller('SentencesUpdateController', ['$scope', '$location', '$routeParams', 'SentencesRest',
...
// sentence控制器
controllersModule.controller('SentencesNewController', ['$scope', '$location', 'SentencesRest',
...
// sentence控制器
controllersModule.controller('SentencesController', ['$scope', '$location', 'SentencesRest', 'MessageBoxService', function ($scope, $location, SentencesRest, MessageBoxService) {
...
// category 控制器
controllersModule.controller('CategoriesController', ['$scope', '$location', 'CategoriesRest', 'MessageBoxService', function ($scope, $location, CategoriesRest, MessageBoxService) {
    $scope.pagesCurrent = 1;
    $scope.pagesTotalPages = 1;
    $scope.sortField = 'id';
    $scope.sortReverse = false;
...
// 目录控制器-创建
controllersModule.controller('CategoriesNewController', ['$scope', '$location', 'CategoriesRest', 'CategoriesTreeService',
...
// 目录控制器-修改
controllersModule.controller('CategoriesUpdateController', ['$scope', '$location', '$routeParams', 'CategoriesRest',
